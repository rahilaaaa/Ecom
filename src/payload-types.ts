...
export interface User {
  ...
  /**
   * Saved products for this customer.
   */
...
export interface Order {
  ...
  items?:
    | {
        ...
        /**
         * Product title snapshot at purchase.
         */
        productTitle?: string | null;
        /**
         * Variant / options label snapshot at purchase.
         */
  ...
  /**
   * Shipping charged at purchase (smallest currency unit).
   */
...
export interface Category {
  ...
  title: string;
  /**
   * Image used for Curated For You and category cards.
   */
  image?: (number | null) | Media;
  /**
   * Short supporting line for Discover category cards.
   */
  description?: string | null;
  /**
   * Show this category in the homepage Curated For You row.
   */
...
export interface Header {
  id: number;
  /**
   * Optional top announcement bar. Leave empty to hide.
   */
...
export interface Footer {
  ...
  legal?:
    ...
    | null;
  /**
   * Legacy flat link list. Used as fallback when Customer Care / Legal are empty.
   */
  navItems?:
    | {
        link: {
...
export interface Discover {
  id: number;
  /**
   * Shown as chips under “Popular Right Now”. Leave empty to use defaults.
   */
  popularSearches?:
    | {
        label: string;
        /**
         * Optional. Defaults to the label when empty.
         */
        query?: string | null;
        id?: string | null;
      }[]
  ...
  newArrivals?: {
    ...
    description?: string | null;
    /**
     * Link to the new arrivals listing (e.g. /shop?badge=new).
     */
    href?: string | null;
  };
  updatedAt?: string | null;
